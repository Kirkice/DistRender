...
use glam::Vec2;
use dist_render_backend::{ash::vk, vk_sync::AccessType, vulkan::image::*, RenderBackend};
use dist_render_rg::{self as rg};
use ngx_dlss::*;
use wchar::wchz;
...
impl DlssRenderer {
    pub fn new(
        ...
        unsafe {
            ...
            let dlss_search_path = dist_render_backend::normalized_path_from_vfs("/dist-render").unwrap_or_else(|_| panic!("/dist-render VFS entry not found. Did you forget to call `set_standard_vfs_mount_points`?"));
