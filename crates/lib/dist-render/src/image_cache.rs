...
use dist_render_asset::{image::RawImage, mesh::TexParams};
use dist_render_backend::{ash::vk, Device, Image, ImageDesc, ImageSubResourceData};
use turbosloth::*;
...
impl LazyWorker for UploadGpuImage {
    ...
    async fn run(self, ctx: RunContext) -> Self::Output {
        ...
        let format = match self.params.gamma {
            dist_render_asset::mesh::TexGamma::Linear => vk::Format::R8G8B8A8_UNORM,
            dist_render_asset::mesh::TexGamma::Srgb => vk::Format::R8G8B8A8_SRGB,
        };
