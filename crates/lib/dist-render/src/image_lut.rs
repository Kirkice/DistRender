...
use dist_render_backend::{vk_sync, vulkan::image::*};
use dist_render_rg as rg;

pub trait ComputeImageLut: Send {
    fn create(&mut self, device: &dist_render_backend::Device) -> Image;
...
impl ImageLut {
    pub fn new(device: &dist_render_backend::Device, mut computer: Box<dyn ComputeImageLut>) -> Self {
        Self {
